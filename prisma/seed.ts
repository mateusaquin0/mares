...
const pathogenGroups = [
  ...
  {
    key: "anthropogenic",
    namePt: "Ações antrópicas",
    nameEn: "Anthropogenic actions",
    usesScientificName: false,
  },
]
...
const pathogens: Array<{
  ...
  {
    key: "erysipelothrix_rhusiopathiae",
    groupKey: "bacteria",
    sci: "Erysipelothrix rhusiopathiae",
  },
  ...
  {
    key: "contaminacao_plastico",
    groupKey: "anthropogenic",
    namePt: "Contaminação ambiental (plástico)",
    nameEn: "Environmental contamination (plastic)",
  },
  {
    key: "rede_pesca",
    groupKey: "anthropogenic",
    namePt: "Rede de pesca (captura acidental)",
    nameEn: "Fishing net (bycatch)",
  },
]
...
const examTypes: {
  ...
  {
    key: "qpcr",
    namePt: "qPCR (PCR em tempo real)",
    nameEn: "qPCR (real-time PCR)",
    measurePt: "Ct",
    measureEn: "Ct",
  },
  ...
  {
    key: "soroneutralizacao",
    namePt: "Soroneutralização",
    nameEn: "Serum neutralization",
    measurePt: "Título (1:)",
    measureEn: "Titer (1:)",
  },
  {
    key: "ifi",
    namePt: "Imunofluorescência Indireta (IFI)",
    nameEn: "Indirect Immunofluorescence (IFA)",
    measurePt: "Título (1:)",
    measureEn: "Titer (1:)",
  },
  {
    key: "hai",
    namePt: "Hemaglutinação Indireta (HAI)",
    nameEn: "Indirect Hemagglutination (IHA)",
    measurePt: "Título (1:)",
    measureEn: "Titer (1:)",
  },
  ...
  {
    key: "microscopia_eletronica",
    namePt: "Microscopia eletrônica",
    nameEn: "Electron microscopy",
  },
...
async function main() {
  ...
  console.log(
    `Seed concluído: ${organs.length} órgãos, ${pathogens.length} patógenos, ${examTypes.length} tipos de exame.`,
  )
